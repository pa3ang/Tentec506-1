...
int ManualCWSpeed = 15; //  <---- SET MANUAL CW SPEED HERE
  ...
  const char txt0[22]         = "ReAllMod v0.9";
  ...
  const char txt66[6]         = "20Mtr";
  const char txt67[6]         = "40Mtr";
...
void setup() 
{
  ...
  attachCoreTimerService(TimerOverFlow);//See function at the bottom of the file.
    ...
    lcd.setCursor(0, 0);
    lcd.print(" Rebel Alliance Mod");           // Spalsh text
    lcd.setCursor(0, 1);
    lcd.print("       v0.9 by");                // Spalsh text
    lcd.setCursor(0, 2);
    lcd.print("  NA8E,K4JK,PA3ANG");            // Spalsh text
    delay(2000);
    lcd.clear();
    ...
    lcd.setCursor(0, 0);
    lcd.print("RebelAllianceMod");              // Spalsh text
    lcd.setCursor(0, 1);
    lcd.print("NA8E,K4JK,PA3ANG");              // Spalsh text
    delay(2000);
    lcd.clear();
